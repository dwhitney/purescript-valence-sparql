...
import Valence.SPARQL.Lexer (anon, blank_node_label, decimal, decimal_negative, decimal_positive, double, double_negative, double_positive, echar, exponent, hex, integer, integer_negative, integer_positive, iriref, langtag, nil, percent, plx, pn_chars, pn_chars_base, pn_chars_u, pn_local, pn_local_esc, pn_prefix, pname_ln, pname_ns, string_literal1, string_literal2, string_literal_long1, string_literal_long2, var1, var2, varname, ws)
...
lexerSpec :: ∀ r. Spec (console :: CONSOLE, random :: RANDOM | r) Unit
lexerSpec = describe "Valence.SPARQL.Lexer" do
